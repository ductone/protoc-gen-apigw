...
func (TerraformEntity_OptionalExclusion) EnumDescriptor() ([]byte, []int) {
	return file_apigw_v1_apigw_proto_rawDescGZIP(), []int{8, 1}
}
...
type FieldOption struct {
	...
	// Sets terraform-specific field configuration
	TerraformField *TerraformField `protobuf:"bytes,3,opt,name=terraform_field,json=terraformField,proto3" json:"terraform_field,omitempty"`
	unknownFields  protoimpl.UnknownFields
	sizeCache      protoimpl.SizeCache
}
...
func (x *FieldOption) GetTerraformField() *TerraformField {
	if x != nil {
		return x.TerraformField
	}
	return nil
}
...
type TerraformField struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	UpdateInPlace bool                   `protobuf:"varint,1,opt,name=update_in_place,json=updateInPlace,proto3" json:"update_in_place,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *TerraformField) GetUpdateInPlace() bool {
	if x != nil {
...
const file_apigw_v1_apigw_proto_rawDesc = "" +
	...
	"\x14webhook_request_name\x18\x04 \x01(\tR\x12webhookRequestName\"\x9b\x01\n" +
	"\vFieldOption\x12#\n" +
	"\rrequired_spec\x18\x01 \x01(\bR\frequiredSpec\x12$\n" +
	"\x0eread_only_spec\x18\x02 \x01(\bR\freadOnlySpec\x12A\n" +
	"\x0fterraform_field\x18\x03 \x01(\v2\x18.apigw.v1.TerraformFieldR\x0eterraformField\"J\n" +
	"\fFieldOptions\x12:\n" +
	...
	"\tdocs_path\x18\x02 \x01(\tR\bdocsPath\"8\n" +
	"\x0eTerraformField\x12&\n" +
	"\x0fupdate_in_place\x18\x01 \x01(\bR\rupdateInPlace\"\x80\x05\n" +
...
var file_apigw_v1_apigw_proto_msgTypes = make([]protoimpl.MessageInfo, 16)
var file_apigw_v1_apigw_proto_goTypes = []any{
	...
	(*TerraformField)(nil),                                  // 13: apigw.v1.TerraformField
	(*TerraformEntity)(nil),                                 // 14: apigw.v1.TerraformEntity
	(*Pagination)(nil),                                      // 15: apigw.v1.Pagination
	(*PaginationInput)(nil),                                 // 16: apigw.v1.PaginationInput
	(*PaginationOutput)(nil),                                // 17: apigw.v1.PaginationOutput
	(*Operation)(nil),                                       // 18: apigw.v1.Operation
	(*RequestExample)(nil),                                  // 19: apigw.v1.RequestExample
	(*ResponseExample)(nil),                                 // 20: apigw.v1.ResponseExample
	nil,                                                     // 21: apigw.v1.Operation.QueryEntry
...
var file_apigw_v1_apigw_proto_depIdxs = []int32{
	...
	14, // 1: apigw.v1.MessageOption.terraform_entity:type_name -> apigw.v1.TerraformEntity
	13, // 2: apigw.v1.FieldOption.terraform_field:type_name -> apigw.v1.TerraformField
	8,  // 3: apigw.v1.FieldOptions.field_options:type_name -> apigw.v1.FieldOption
	18, // 4: apigw.v1.MethodOptions.operations:type_name -> apigw.v1.Operation
	12, // 5: apigw.v1.ServiceOptions.service:type_name -> apigw.v1.Service
	...
	2,  // 8: apigw.v1.TerraformEntity.optional_exclusion:type_name -> apigw.v1.TerraformEntity.OptionalExclusion
	3,  // 9: apigw.v1.Pagination.type:type_name -> apigw.v1.Pagination.TerraformEntityPaginationType
	16, // 10: apigw.v1.Pagination.inputs:type_name -> apigw.v1.PaginationInput
	17, // 11: apigw.v1.Pagination.outputs:type_name -> apigw.v1.PaginationOutput
	4,  // 12: apigw.v1.PaginationInput.in:type_name -> apigw.v1.PaginationInput.TerraformEntityPaginationInputIn
	5,  // 13: apigw.v1.PaginationInput.type:type_name -> apigw.v1.PaginationInput.TerraformEntityPaginationInputType
	21, // 14: apigw.v1.Operation.query:type_name -> apigw.v1.Operation.QueryEntry
	0,  // 15: apigw.v1.Operation.stability:type_name -> apigw.v1.Stability
	19, // 16: apigw.v1.Operation.request_examples:type_name -> apigw.v1.RequestExample
	20, // 17: apigw.v1.Operation.response_examples:type_name -> apigw.v1.ResponseExample
	14, // 18: apigw.v1.Operation.terraform_entity:type_name -> apigw.v1.TerraformEntity
	15, // 19: apigw.v1.Operation.pagination:type_name -> apigw.v1.Pagination
	22, // 20: apigw.v1.service:extendee -> google.protobuf.ServiceOptions
	23, // 21: apigw.v1.method:extendee -> google.protobuf.MethodOptions
	24, // 22: apigw.v1.field:extendee -> google.protobuf.FieldOptions
	25, // 23: apigw.v1.message:extendee -> google.protobuf.MessageOptions
	11, // 24: apigw.v1.service:type_name -> apigw.v1.ServiceOptions
	10, // 25: apigw.v1.method:type_name -> apigw.v1.MethodOptions
	9,  // 26: apigw.v1.field:type_name -> apigw.v1.FieldOptions
	6,  // 27: apigw.v1.message:type_name -> apigw.v1.MessageOptions
