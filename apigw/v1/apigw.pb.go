...
type FieldOption struct {
	...
	TerraformField *TerraformField `protobuf:"bytes,5,opt,name=terraform_field,json=terraformField,proto3" json:"terraform_field,omitempty"`
	unknownFields  protoimpl.UnknownFields
	sizeCache      protoimpl.SizeCache
}
...
const file_apigw_v1_apigw_proto_rawDesc = "" +
	...
	"\x14webhook_request_name\x18\x04 \x01(\tR\x12webhookRequestName\"\x87\x02\n" +
	"\vFieldOption\x12#\n" +
	...
	"\vdeprecation\x18\x04 \x01(\v2\x15.apigw.v1.DeprecationR\vdeprecation\x12A\n" +
	"\x0fterraform_field\x18\x05 \x01(\v2\x18.apigw.v1.TerraformFieldR\x0eterraformField\"J\n" +
	"\fFieldOptions\x12:\n" +
	...
	"\x0fupdate_in_place\x18\x01 \x01(\bR\rupdateInPlace\"D\n" +
	"\rMethodOptions\x123\n" +
	"\n" +
...
var file_apigw_v1_apigw_proto_goTypes = []any{
	...
	(*TerraformField)(nil),                                  // 11: apigw.v1.TerraformField
...
var file_apigw_v1_apigw_proto_depIdxs = []int32{
	...
	11, // 4: apigw.v1.FieldOption.terraform_field:type_name -> apigw.v1.TerraformField
	8,  // 5: apigw.v1.FieldOptions.field_options:type_name -> apigw.v1.FieldOption
	19, // 6: apigw.v1.MethodOptions.operations:type_name -> apigw.v1.Operation
	...
	12, // 29: apigw.v1.method:type_name -> apigw.v1.MethodOptions
