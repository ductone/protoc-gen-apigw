...
const file_bookstore_v1_bookstore_proto_rawDesc = "" +
	...
	"\x04name\x18\x02 \x01(\tR\x04name:\x11\xaa\xde\x03\r\n" +
	"\v\n" +
	"\t\x12\x05Genre\x18\x01\"\x91\x01\n" +
	"\x04Book\x12\x18\n" +
	"\x02id\x18\x01 \x01(\tB\b\xa2\xde\x03\x04\n" +
	"\x02\b\x01R\x02id\x12\x16\n" +
	...
	"\bmetadata\x18\x05 \x01(\tB\b\xa2\xde\x03\x04\n" +
	"\x02\x10\x01R\bmetadata\x12C\n" +
	"\n" +
	"created_at\x18\x06 \x01(\v2\x1a.google.protobuf.TimestampB\b\xa2\xde\x03\x04\n" +
	"\x02\x10\x01R\tcreatedAt\x12*\n" +
	...
	"\x05books\x18\x01 \x03(\v2\x12.bookstore.v1.BookR\x05books2\xa4\x0f\n" +
	...
	"\x18\n" +
	"\x03GET\x12\b/shelvesR\aShelves\x12\x85\x01\n" +
	"\vCreateShelf\x12 .bookstore.v1.CreateShelfRequest\x1a!.bookstore.v1.CreateShelfResponse\"1\x9a\xde\x03-\n" +
	"+\n" +
	"\x04POST\x12\x06/shelfJ\x12Create a New ShelfR\aShelves\x12}\n" +
	"\vDeleteShelf\x12 .bookstore.v1.DeleteShelfRequest\x1a!.bookstore.v1.DeleteShelfResponse\")\x9a\xde\x03%\n" +
	"#\n" +
	"\x06DELETE\x12\x10/shelves/{shelf}R\aShelves\x12m\n" +
	"\n" +
	"ListGenres\x12\x1f.bookstore.v1.ListGenresRequest\x1a .bookstore.v1.ListGenresResponse\"\x1c\x9a\xde\x03\x18\n" +
	"\x16\n" +
	"\x03GET\x12\a/genresR\x06Genres\x12\x84\x01\n" +
	"\vCreateGenre\x12 .bookstore.v1.CreateGenreRequest\x1a!.bookstore.v1.CreateGenreResponse\"0\x9a\xde\x03,\n" +
	"*\n" +
	"\x04POST\x12\x06/genreJ\x12Create a New GenreR\x06Genres\x12~\n" +
	...
	"/\n" +
	"\x04POST\x12\x16/shelves/{shelf}/booksB\b\b\x01\x12\x04BookR\x05Books\x12\xd2\x01\n" +
	"\aGetBook\x12\x1c.bookstore.v1.GetBookRequest\x1a\x1d.bookstore.v1.GetBookResponse\"\x89\x01\x9a\xde\x03\x84\x01\n" +
	"\x81\x01\n" +
	...
	"\x1c\n" +
	"\x03GET\x12\n" +
	"/recursiveR\tRecursiveB:Z8github.com/ductone/protoc-gen-apigw/example/bookstore/v1b\x06proto3"
